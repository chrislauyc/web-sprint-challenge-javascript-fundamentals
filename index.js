...
// if internal is not declared inside nestedFunction, javascript will look at the parent scope, which is the myFunction, and find the declared and initialized internal variable.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(data){
    return data.reduce((acc,animal) => acc+animal.population, 0);
  }
